...
describe("ResourceId", function () {
    const verify = function (resource, resourceType) {
        ...
        else if (resourceType === "udf" &&
            resource.database !== 0 &&
            resource.documentCollection !== 0 &&
            resource.userDefinedFunction !== 0) {
            return true;
        }
        else if (resourceType === "pkr" &&
            resource.database !== 0 &&
            resource.documentCollection !== 0 &&
    ...
    it("validate ResourceId's parse and toString functions", function () {
        const rid = new common_1.ResourceId();
        const offerId = "HW1D";
...
//# sourceMappingURL=ResourceId.spec.js.map