...
export declare class RequestHandler {
    ...
    static createRequestObjectStub(connectionPolicy: ConnectionPolicy, requestOptions: RequestOptions, body: Body): Promise<Response<any>>;
    /**
     ...
     */
    static request(globalEndpointManager: GlobalEndpointManager, connectionPolicy: ConnectionPolicy, requestAgent: Agent, method: string, hostname: string, request: RequestContext, data: string | Buffer | Stream, queryParams: any, // TODO: any query params types
