...
import * as httpsTypes from "https";
...
/** @hidden */
export declare function createRequestObject(connectionPolicy: ConnectionPolicy, requestOptions: httpsTypes.RequestOptions, body: Body): Promise<Response<any>>;
