...
export declare class VectorSessionToken {
    ...
    constructor(version: number, globalLsn: number, localLsnByregion: Map<number, BigInt.BigInteger>, sessionToken?: string);
    static create(sessionToken: string): VectorSessionToken;
